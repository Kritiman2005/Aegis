...
const CONNECTOR_DEFS = [
  {
    ...
    authType: 'oauth',
    loginUrl: 'http://127.0.0.1:8000/auth/google/login?service=google_drive',
    icon: (
  ...
  },
  {
    ...
    authType: 'oauth',
    loginUrl: 'http://127.0.0.1:8000/auth/google/login?service=google_mail',
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6" fill="none">
  ...
  },
  {
    ...
    authType: 'oauth',
    loginUrl: 'http://127.0.0.1:8000/auth/google/login?service=google_docs',
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6" fill="none">
  ...
  },
  {
    ...
    authType: 'oauth',
    loginUrl: 'http://127.0.0.1:8000/auth/google/login?service=google_sheets',
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6" fill="none">
  ...
  },
  {
    ...
    oauthService: 'figma',
    authType: 'oauth',
    loginUrl: 'http://127.0.0.1:8000/auth/figma/login',
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6" fill="none">
  ...
  },
  {
    ...
    oauthService: 'notion',
    authType: 'oauth',
    loginUrl: 'http://127.0.0.1:8000/auth/notion/login',
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6" fill="none">
  ...
  },
  {
    ...
    oauthService: 'github',
    authType: 'oauth',
    loginUrl: 'http://127.0.0.1:8000/auth/github/login',
    icon: (
